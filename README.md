...
Troll items:
- Rift Expeller (weapon):
     When fired at a ship, it causes it to phase out of reality (to the final battle :))
     If at final battle, it instead duplicates that ship exactly (same damage, weapon condition, etc.)
...
COMBAT:
You control your fleet (similar to MOO2), but ships have inertia and stuff
Weapon types:
